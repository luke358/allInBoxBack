...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://localhost:3306/allInBox?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";   //注意修改数据库名
        String name="root";
        String password="123456";

        //数据库表的设置
        List<String> listTable = Arrays.asList("user", "app", "user_app");  //设置需要自动代码生成的表名
        List<String> listTableSuffix = Arrays.asList("_b");    //设置 过滤 表的后缀
        List<String> listTablePrefix = Arrays.asList("t_","c_"); //设置 过滤 表的后缀

        //基本信息
        String author = "luke";    //作者
        String parent = "com.luke";   //父包名
        String module = "allinboxback";   //模块包名
        ...
        FastAutoGenerator.create(url, name, password)
                ...
                .strategyConfig(builder -> {
                    builder
                            ...
                            .addTableSuffix(String.valueOf(listTableSuffix)) //设置 过滤 表的后缀
                            .addTablePrefix(String.valueOf(listTablePrefix)) // 设置 过滤 表的前缀
